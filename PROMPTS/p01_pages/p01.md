...
## Behavior 
- When started it should show the 'Home' Page along with the options shown in the image file in this folder (PhP-MVC-Home-Page.png)
- If someone chooses to 'Login' the following 'Login Page' is shown. Refer image file in this folder (PhP-MVC-Login-Page.png)
- On successful login
   - If the user has a 'admin' role then he is directly taken to 'admin page'. An admin can create new users, activate, deactivate, promote users. He can also edit the user details. Refer image file in this folder (PhP-MVC-Admin-Page.png)
   - if the user has a 'user' role then he is taken to 'user page'. Refer image file in this folder (PhP-MVC-User-Page.png)
- if someone chooses 'sign up' he is taken to 'new user page'. Refer image file in this folder (PhP-MVC-New-User-Page.png)
